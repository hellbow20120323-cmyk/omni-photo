...
export default function DedupeSettingsCard({ checked, onChange }: DedupeSettingsCardProps) {
  ...
  const infoTip =
    mode === "zh-only"
      ...
      : "On: compares with existing archive; duplicates → _Duplicates. Off: in-batch dedupe only; archive not scanned.";

  return (
    <motion.div
      layout
      className="rounded-2xl border border-white/22 bg-white/16 px-4 py-3.5 shadow-glass-sm backdrop-blur-md"
      ...
      <div className="flex items-start gap-3 sm:gap-4">
        <div className="flex min-w-0 flex-1 items-start gap-2.5">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-2 space-y-2.5 text-[11px] leading-relaxed">
              <BilingualStack
